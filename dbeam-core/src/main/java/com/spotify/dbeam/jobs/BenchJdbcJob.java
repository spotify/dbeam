...
public class BenchJdbcJob {

  /** Functional interface for creating a job and running it, given an output path. */
  @FunctionalInterface
  public interface JobRunner {
    PipelineResult runExport(PipelineOptions pipelineOptions, String output) throws Exception;
  }

  public interface BenchJdbcOptions extends PipelineOptions {
  ...
  public static BenchJdbcJob create(
      final String jobName,
      final String[] cmdLineArgs,
      final Function<String[], PipelineOptions> optionsBuilder,
      final JobRunner jobRunner) {
    PipelineOptions options = optionsBuilder.apply(cmdLineArgs);
    return new BenchJdbcJob(jobName, options, jobRunner);
  }

  public void run() throws Exception {
    int executions = pipelineOptions.as(BenchJdbcOptions.class).getExecutions();
    ...
    System.out.println("Summary for " + jobName);
