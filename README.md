...
Instructions can be found here: [Maven setup with OTN Network](https://blogs.oracle.com/dev2dev/get-oracle-jdbc-drivers-and-ucp-from-oracle-maven-repository-without-ides--)
```sh
<settings>
  <proxies>
    <proxy>
